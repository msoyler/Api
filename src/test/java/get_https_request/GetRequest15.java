...
public class GetRequest15 extends GMIBankBasUrl {
    ...
    public void test15() {
     ...
     "email": "winonaabernathy@gmail.com"
        ...
        response.prettyPrint(); //butun bilgileri almak icin

        //MATCHERS CLASS İLE

        response.then().body("user.login", equalTo("dino.kohler")
                ,"user.firstName",equalTo("Winona"),"user.lastName",equalTo("Abernathy")
